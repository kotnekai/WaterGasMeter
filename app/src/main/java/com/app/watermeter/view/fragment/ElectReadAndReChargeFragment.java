 ...
 * @author admin
 */
public class ElectReadAndReChargeFragment extends BaseFragment {
    ...
    public ElectReadAndReChargeFragment() {
    }
    ...
    public static ElectReadAndReChargeFragment newInstance(int meterType, String meterTitle, int fromPageType) {
        Bundle args = new Bundle();
        args.putString(KEY_TITLE, meterTitle);
        args.putInt(KEY_METER_TYPE, meterType);
        args.putInt(KEY_PAGE, fromPageType);
        ElectReadAndReChargeFragment fragment = new ElectReadAndReChargeFragment();
    ...
    public void onEvent(GetElectReChargeListEvent event) {
     ...
     */
    @Subscribe(threadMode = ThreadMode.MAIN)
    public void onEvent(GetElectReadListEvent event) {
        currentPageSize += event.getList().size();
    ...
    @Subscribe(threadMode = ThreadMode.MAIN)
    public void onEvent(GetElectTransactionListEvent event) {
        currentPageSize += event.getList().size();
