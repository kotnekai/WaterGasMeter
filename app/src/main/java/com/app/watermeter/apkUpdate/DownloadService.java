...
import com.app.watermeter.utils.FileUtils;
import com.app.watermeter.utils.NotificationUtil;
import com.app.watermeter.utils.PageIntentUtils;
...
public class DownloadService extends Service {
    ...
    private DownloadApkListener listener = new DownloadApkListener() {
        ...
        public void onProgress(int progress) {
            ...
            NotificationUtil.getNotificationManager(context).notify(1, NotificationUtil.getLoadNotification(context, "下载中。。", progress, PageIntentUtils.getPendIntent(context,null)));
        }
        ...
        public void onFailed() {
            ...
            stopForeground(true);
            NotificationUtil.getNotificationManager(context).notify(1,NotificationUtil.getLoadNotification(context,"下载失败",-1,PageIntentUtils.getPendIntent(context,null)));
    ...
    class DownloadBinder extends Binder {
        ...
        public void startDownload(String url) {
            ...
            if (downloadTask == null) {
                ...
                startForeground(1, NotificationUtil.getLoadNotification(context, "开始下载...", 0, PageIntentUtils.getPendIntent(context,null)));
